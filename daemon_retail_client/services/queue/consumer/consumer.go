...
import (
	...
	"github.com/GodCratos/retail_client/services"
...
func NsqListen() {
	...
	consumer, err := nsq.NewConsumer(configs.NsqGetTopicRetailClient(), configs.NsqGetChannel(), config)
	if err != nil {
...
func (h *messageHandler) HandleMessage(message *nsq.Message) error {
	...
	err = services.RetailGetClientByFilter(QueueMessage)
	if err != nil {
