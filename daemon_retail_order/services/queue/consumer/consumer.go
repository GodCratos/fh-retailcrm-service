...
import (
	...
	"github.com/GodCratos/retail_order/services"
...
func NsqListen() {
	...
	consumer, err := nsq.NewConsumer(configs.NsqGetTopicRetailOrder(), configs.NsqGetChannel(), config)
	if err != nil {
...
func (h *messageHandler) HandleMessage(message *nsq.Message) error {
	...
	err = services.RetailGetOrderByFilter(QueueMessage)
	if err != nil {
